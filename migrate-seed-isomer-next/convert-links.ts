...
// CANNOT FIND:
// - moh-vwo-contingency-fund---22m-awarded.json
// - singapore's-biomedical-sciences-r-d-effort-gets-boost-of-s37-billion.json
const NEW_TO_OLD_PATHS: Record<string, string> = {
  "government-accepts-medishield-life-council-s-recommendations-and-commits-22-billion-for-premium-subsidies-and-support":
    "government-accepts-medishield-life-council-s-recommendations-to-enhance-medishield-life-scheme---government-support-more-than-offsets-premium-increases",
  "honorary-citizen-award-conferred-on-professor-k-ranga-rama-krishnan-and-professor-duane-j-gubler":
    "honorary-citizen-award-conferred-on-professor-k-ranga-rama-krishnan-and-professor-duane-j.-gubler",
  "new-personal-guide-based-on-1-hr-pm25-concentration-readings-to-guide-the-public-during-haze-season":
    "new-personal-guide-based-on-1-hr-pm2.5-concentration-readings-to-guide-the-public-during-haze-season",
  "rise-in-ba4-and-ba5-subvariant-cases-drives-recent-increase-in-covid-19-cases":
...
// const main = async () => {
//   const REPO = "/Users/zhongjun/moh-corp-next/schema/newsroom";
//   process.chdir(REPO);
...
//     JSON.stringify(REPORT.map((item) => RECORD[item]z), null, 2)
//   );
// };
