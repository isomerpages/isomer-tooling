      ...
      "content": [
        {
          "type": "text",
          "marks": [],
          "text": "Based on transacted bills from 1 January 2023 to 31 December 2023. The amount shown covers all cost components inclusive of GST."
        }
      ]
    })
            ...
            "content": [
              {
                ...
                "content": [
                  {
                    "type": "text",
                    "text": "$" + record['P25 Bill'].replace(" ", "") + " - $" + record['P75 Bill'].replace(" ", "")
                  }
                ]
              }
            ]
